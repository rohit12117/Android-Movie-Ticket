...
class Movie2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_movie2) // Set the content view
        ...
        btnTime = findViewById(R.id.btnTime2)
        btnTrail = findViewById(R.id.btnTrail2)
        btnAlarm = findViewById(R.id.btnAlarm2)
        btnAlarmStop = findViewById(R.id.btnAlarmStop)
        btnBook = findViewById(R.id.btnBook2)
        tv = findViewById(R.id.tv2)
        etText = findViewById(R.id.etText2)
        ...
        btnTrail.setOnClickListener {
            startActivity(Intent(this, Trailer::class.java))
        }
        ...
        btnAlarmStop.setOnClickListener {
            val intent = Intent(this, AlarmBroad::class.java).apply {
                action = AlarmBroad.ACTION_STOP_ALARM // Set action to stop the alarm
            }
            val pendingIntent = PendingIntent.getBroadcast(this, 234, intent, PendingIntent.FLAG_IMMUTABLE)
        ...
        btnBook.setOnClickListener {
            val movieName = findViewById<TextView>(R.id.textView12).text.toString()
            val date = selectedDate
            val time = selectedTime
            val tickets = findViewById<EditText>(R.id.etTickets2).text.toString().toIntOrNull() ?: 0
