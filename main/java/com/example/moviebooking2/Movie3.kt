...
import com.example.moviebooking2.R.layout.activity_movie3
...
class Movie3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(activity_movie3)
        val btnDate = findViewById<Button>(R.id.btnDate3)
        ...
        val btnTime = findViewById<Button>(R.id.btnTime3)
        var alarmManager: AlarmManager
        val intent = Intent(this, AlarmBroad::class.java)
        val pendingIntent = PendingIntent.getBroadcast(this, 234, intent,
            PendingIntent.FLAG_IMMUTABLE)

        var tv = findViewById<TextView>(R.id.tv3)
        var etText = findViewById<EditText>(R.id.etText3)
//      Putting the time picker
        ...
        val btntrail = findViewById<Button>(R.id.btnTrail3)
        ...
        val btnBook = findViewById<Button>(R.id.btnBook3)
